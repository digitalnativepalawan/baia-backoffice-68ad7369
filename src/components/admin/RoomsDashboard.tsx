...
import { SignedGuestDocImage, SignedGuestDocLink } from '@/components/SignedGuestDoc';
            ...
            {documents.map((doc: any) => (
              <div key={doc.id} className="border border-border rounded-lg overflow-hidden">
                {doc.image_url && !doc.image_url.startsWith('http://') && doc.image_url.includes('guest-documents') ? (
                  <SignedGuestDocImage src={doc.image_url} alt="Document" className="w-full max-h-64 object-contain bg-secondary" />
                ) : (
                ...
                <div className="flex justify-between items-center p-2">
                  ...
                  <div className="flex gap-1">
                    <SignedGuestDocLink href={doc.image_url}>
                ...
                <div key={note.id} className="border border-border rounded-lg p-3">
                  <div className="flex justify-between items-start">
                    <div className="flex-1 min-w-0">
                      ...
                      {isImage ? (
                        <SignedGuestDocLink href={imageUrl!}>
                          <SignedGuestDocImage src={imageUrl!} alt="Note attachment" className="max-h-40 rounded mt-1 object-contain bg-secondary" />
                        </SignedGuestDocLink>
                      ) : (
